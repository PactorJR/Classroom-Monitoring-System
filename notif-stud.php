                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="stud-notif.php">Notifications</a>
                                <a class="nav-link" href="rooms-list-stud.php">Rooms List</a>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <p class="mb-2 h3">Notifications</p>
                        </div>
                        <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-header ">
                                                    <p class="text-center h1">Notifications</p>
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <?php
                                                                $room_rid = '';
                                                                ...
                                                                $room_day = '';
                                                                    ...
                                                                    if ($ridrows > 0) {
                                                                        ...
                                                                        $room_day = $resultnotif1['room_day'];
                                                                ...
                                                                $sqlnotif = "SELECT * FROM roomtbl WHERE room_year = '$res_year' AND room_section = '$res_section' AND room_day LIKE '%$currentDay' AND seen = 0 ORDER BY made_at DESC";
                                                                ...
                                                                if ($queryrow == 0) {
                                                                    ...
                                                                    while ($resultnotif = mysqli_fetch_assoc($querynotif)) {
                                                                        ...
                                                                        echo '<div class="card p-3 mb-4 mt-4 '. $icon_color . '">';
                                                                        echo '<a class="text-center" style="color:black;text-decoration:none;"href="notif-stud.php?roomrid=' . $resultnotif['sched_code'] . '"> Room: ' . $resultnotif['comb'] . ' Year & Section: ' . $resultnotif['room_year'] . ' '. $resultnotif['room_section'] . '
                                                                        ...
                                                                        '<br> Room Status: ' . $resultnotif['status'] .
                                                                         '</a>';
                                                                        echo '</div>';
                                                                        echo '</div>';
                                                                    }
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="form-group row justify-content-center">
                                                            <div class="col-md-2 m-auto text-center">
                                                                ...
                                                                <input style="font-size:25px;width:50px" class="text-center mb-4" value="<?php echo $room_attend; ?>" name="attend" type="text" required></input>
                                                            </div>
                                                            <div class="col-md-2 m-auto text-center">
                                                                <label style="font-size:25px;" class="m-auto mb-3" name="section" id="section" type="text">Not Attending</label><br>
                                                                <input style="font-size:25px;width:50px" class="text-center mb-4" value="<?php echo $room_not; ?>" name="not" type="text" required></input>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    </div>
