                                                    ...
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <?php
                                                                ...
                                                                $sqlnotif = "SELECT * FROM roomtbl  WHERE room_year = '$res_year' AND room_section = '$res_section' AND room_day LIKE '%$currentDay' ORDER BY made_at DESC";
                                                                ...
                                                                if ($queryrow == 0) {
                                                                    ...
                                                                    while ($resultnotif = mysqli_fetch_assoc($querynotif)) {
                                                                        ...
                                                                        echo '<a class="text-center" style="color:black;text-decoration:none;"href="rooms-status-stud.php?roomrid=' . $resultnotif['sched_code'] . '"> Room: ' . $resultnotif['comb'] . ' Year & Section: ' . $resultnotif['room_year'] . ' ' . $resultnotif['room_section'] .'
                                        ...
                                        <?php
                                                ...
                                                if ($queryrow == 0) {
                                                    ...
                                                    while ($resultuser1 = mysqli_fetch_assoc($queryroom)) {
                                                        ...
                                                        echo '<tbody>';
                                                        echo '<tr onclick="window.location=\'room-status-stud.php?selid=' . $user_id . '\'">';
                                                        echo '<td>' . $user_id . '</td>';
