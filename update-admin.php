        ...
        <div id="layoutSidenav_nav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Update Rooms & Users</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="home-admin.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Update Rooms & Users</li>
                    </ol>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                                    ...
                                                    if(isset($_POST['user_searchbtn'])){
                                                            ...
                                                            if ($qresults > 0) {
                                                                while($resultUser = mysqli_fetch_assoc($result)){
                                                                    echo '<tr style="display:' . $vis . '" onclick="window.location=\'update-admin.php?selid=' . $resultUser['id'] . '\'">';
                                                ...
                                                <table style="cursor:pointer;" class="table table-bordered table-hover text-center">
                                                    ...
                                                    if ($result) {
                                                        while($resultRoom = mysqli_fetch_assoc($result)){
                                                            echo '<tr class="room-row" style="display:' . $vis . '" onclick="window.location=\'update-admin.php?selrid=' . $resultRoom['sched_code'] . '\'">';
                                    ...
                                    <h4><?php echo $clk_fname . ' ' . $clk_lname; ?></h4>
                                            ...
                                            <div class="card mt-5 mb-4">
                                                <div class="card-header">
                                                    ...
                                                    <form action="update-admin.php?selid=<?php echo $selid; ?>" method="post">
                                                        ...
                                                        <div class="form-group row justify-content-center">
                                                            <button class="btn btn-primary mt-4 mb-5" type="submit" style="width:150px;" name="update-user">Update User</button>
                                                        </div>
                                                    </form>
                                                    <?php
                                                    if (isset($_POST['update-user'])){
                                                        ...
                                                        if ($password == $conf_password) {
                                                            ...
                                                            if (mysqli_query($conn, $sqlUpdate)) {
                                                                ...
                                                                echo '<script>window.location.href = "update-admin.php";</script>';
                                                            } else {
                                                                echo '<script>alert("Error updating user: ' . mysqli_error($conn) . '")</script>';
                                                                echo '<script>window.location.href = "update-admin.php";</script>';
                                                            }
                                                        } elseif ($conf_password == ""){
                                                            echo '<script>alert("Input password first")</script>';
                                                            echo '<script>window.location.href = "update-admin.php";</script>';
                                                        }else {
                            ...
                            <div class="col-md-6">
                                <div class="card mb-4" id="selected-roon-div">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="card mt-5 mb-4">
                                            <div class="card-header">
                                                <p class="mb-2 h3">Update Room</p>
                                            </div>
                                            <div class="card-body">
                                                <form action="update-admin.php?selrid=<?php echo $selrid; ?>" method="post">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        <div class="form-group row justify-content-center mt-5 mb-5">
                                                            <button class="btn btn-primary" type="submit" name="update-room" style="width:150px;">Update Room</button>
                                                        </div>
                                                    </div>
                                                </form>
                                                <?php
                                                if (isset($_POST['update-room'])) {
                                                    $e_prof_fname = mysqli_real_escape_string($conn, $_POST['prof_fname']);
                                                    $e_prof_lname = mysqli_real_escape_string($conn, $_POST['prof_lname']);
                                                    $e_room_type = mysqli_real_escape_string($conn, $_POST['room_type']);
                                                    $e_room_num = mysqli_real_escape_string($conn, $_POST['room_num']);
                                                    $e_start_time = mysqli_real_escape_string($conn, $_POST['start_time']);
                                                    $e_end_time = mysqli_real_escape_string($conn, $_POST['end_time']);
                                                    $e_status = mysqli_real_escape_string($conn, $_POST['room_status']);
                                                    $e_comb = $e_room_type . $e_room_num;
                                                    $e_room_year = mysqli_real_escape_string($conn, $_POST['room_year']);
                                                    $e_room_section = mysqli_real_escape_string($conn, $_POST['room_section']);
                                                    
                                                    // Process checkboxes for days
                                                    $e_room_day = isset($_POST['room_day']) ? implode(',', $_POST['room_day']) : '';
                                                
                                                    $updateroom_sql = "UPDATE roomtbl SET 
                                                        prof_fname = '$e_prof_fname', 
                                                        prof_lname = '$e_prof_lname', 
                                                        ...
                                                        status = '$e_status', 
                                                        comb = '$e_comb', 
                                                        room_year = '$e_room_year',
                                                        room_section = '$e_room_section',
                                                        room_day = '$e_room_day' 
                                                        WHERE sched_code = '$selrid'"; // Assuming $selrid is already defined
                                                    
                                                    $updateroom_query = mysqli_query($conn, $updateroom_sql);
                                                    
                                                    if ($updateroom_query) {
                                                        echo '<script>alert("Successfully Edited the selected Room")</script>';
                                                        echo '<script>window.location.href = "update-admin.php";</script>';
                                                    } else {
