...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="home-teach.php" >Teacher Home</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card bg-primary text-white mb-4">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="#">View Profile</a>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Rooms Number: <?php echo $rooms_number; ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="rooms-list-teach.php">View More</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Available Rooms: <?php echo $available_rooms; ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                    <form id="statusForm" action="rooms-list-teach.php" method="POST">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Occupied Rooms: <?php echo $occupied_rooms; ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                    <form id="statusForms" action="rooms-list-teach.php" method="POST">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-dark text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="notif-teach.php">View More</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body text-center">
                                <table class="datatable-table">
                                    ...
                                    <?php
                                        ...
                                        $sqlroom = "SELECT * FROM roomtbl WHERE madeby = '$id' ORDER BY made_at DESC";
                                        $queryroom = mysqli_query($conn, $sqlroom);
                                        $scheduled =  mysqli_num_rows($queryroom);
                                        $rooms_number = mysqli_num_rows($queryroom);
