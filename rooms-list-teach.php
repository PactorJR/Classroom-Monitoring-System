                            ...
                            <div class="card-body">
                                <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
                                    <div class="container-fluid">
                                        <form class="d-none d-md-inline-block mt-2 w-100" action="rooms-list.php" method="post">
                                            <div class="row">
                                                <!-- Sort Input Group -->
                                                <div class="col-md-6">
                                    ...
                                    if (isset($_POST['status'])){
                                        ...
                                        $status = $_POST['status'];
                                                ...
                                                echo '<div class="row">';   
                                                $sql = "SELECT * FROM roomtbl WHERE status = '$status'";
                                    ...
                                    $vis = "";
                                        if(isset($_POST['searchbtn'])){
                                            ...
                                            $vis = "show";
                                                ...
                                                $sql = "SELECT * FROM roomtbl WHERE prof_fname LIKE '%$search%' OR prof_lname LIKE '%$search%' OR room_type LIKE '%$search%' OR room_num LIKE '%$search%' OR comb LIKE '%$search%' OR status LIKE '%$search%'";
                                                $result = mysqli_query($conn, $sql);
                                        ...
                                        if(isset($_POST['sortbtn'])){
                                            if ($_POST['roomtype'] === "ALL" && !isset($_POST['searchbtn'])) {
                                                $vis = "show";
                                                $queryroom = mysqli_query($conn, "SELECT * FROM roomtbl");
                                                echo '<div class="container">';
                                                echo '<div class="row">';
