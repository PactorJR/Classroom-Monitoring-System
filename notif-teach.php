                                    ...
                                    <div class="row">
                                                            ...
                                                            <?php
                                                                ...
                                                                if ($queryrow == 0) {
                                                                    ...
                                                                    while ($resultnotif = mysqli_fetch_assoc($querynotif)) {
                                                                        ...
                                                                        echo '<a class="text-center" style="color:black;text-decoration:none;"href="notif-teach.php?roomrid=' . $resultnotif['sched_code'] . '"> Room: ' . $resultnotif['comb'] . ' Year & Section: ' . $resultnotif['room_year'] . ' ' . $resultnotif['room_section'] .'
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="text-center h1">Room Selected</p>
                                                    <div class="card">
                                                    <div class="card-header">
                                                    <form action="notif-teach.php?roomrid=<?php echo $roomrid; ?>" method="post">
